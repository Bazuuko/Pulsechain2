  ...
  return (
    <s.Screen>
      ...
      <s.Container
        ...
        image={CONFIG.SHOW_BACKGROUND ? "/config/images/bgplanetas.jpg" : null}
      >
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          ...
          <s.Container
            ...
            style={{
              padding: 60,
              borderRadius: 60,
              boxShadow: "0px 20px 20px 10px rgba(0,0,0,0.7)",
          ...
          >
            ...
            <StyledImg
              ...
              style={{
                borderRadius: 60,
                boxShadow: "0px 20px 10px 5px rgba(0,0,0,0.7)",
              }}
